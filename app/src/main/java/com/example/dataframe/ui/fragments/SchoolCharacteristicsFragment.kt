...
import com.example.dataframe.databinding.FragmentSchoolCharacteristicsBinding
...
@AndroidEntryPoint
class SchoolCharacteristicsFragment : Fragment() {
    private var binding: FragmentSchoolCharacteristicsBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentSchoolCharacteristicsBinding.inflate(inflater, container, false)
    ...
    private fun submitDetails() {
        ...
        appViewModel.saveSchoolDetails(requestBody)
    }
