...
import com.example.dataframe.databinding.FragmentHivBinding
...
class HIVFragment : Fragment() {
    private var binding: FragmentHivBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentHivBinding.inflate(inflater, container, false)
